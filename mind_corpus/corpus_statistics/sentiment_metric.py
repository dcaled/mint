...
class SentimentMetric(Metric):
    ...
    def compute_metric(self, text_as_list):
        ...
        positive_contrast = 0 if self.__compute_positive_contrast(
            text_as_list) == 0 else self.__compute_positive_contrast(text_as_list) / n_sentiment
        negative_contrast = 0 if self.__compute_negative_contrast(
            text_as_list) == 0 else self.__compute_negative_contrast(text_as_list) / n_sentiment
